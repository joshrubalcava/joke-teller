...
function tellJoke( joke ) {
	const apiKey = 'fbd436f7e5994806b5fbf7f66f15a8ad';
...
async function getJoke() {
	...
	try {
		...
		// passes the joke to the VoiceRSS API function
		tellJoke( joke );
		// enables/disables joke button depending on if a joke is being told or not
		toggleJokeBtn();
	} catch (err) {
		console.log( err );
	}
...
audioElement.addEventListener( 'ended', toggleJokeBtn );